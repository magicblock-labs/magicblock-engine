...
/// Builds a program-cache entry from a normalized executable account.
///
/// The caller must supply raw ELF bytes in `program.data()`. Decoding
/// loader-specific account headers or indirection is outside the SVM boundary.
///
